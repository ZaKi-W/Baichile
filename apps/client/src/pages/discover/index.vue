...
<style scoped>
.cart-page { min-height: 100vh; color: #171717; background: #f6f6f6; }
.safe-top { background: #ffd400; }
...
.store-cart-card, .summary-card, .empty-card { border: 1rpx solid #ececec; border-radius: 24rpx; background: #fff; }
...
.line-price { margin-top: 12rpx; color: #f04426; font-size: 27rpx; font-weight: 900; }
...
.summary-total { margin-top: 22rpx; padding-top: 22rpx; border-top: 1rpx solid #f0f0ee; color: #171717; font-size: 30rpx; font-weight: 900; }
.summary-total text:last-child { color: #f04426; font-size: 36rpx; }
...
.empty-mark { width: 112rpx; height: 112rpx; display: flex; align-items: center; justify-content: center; margin-bottom: 26rpx; border-radius: 32rpx; color: #171717; background: #ffd400; font-size: 48rpx; font-weight: 900; }
...
.browse-button { margin-top: 34rpx; padding: 20rpx 42rpx; border-radius: 999rpx; color: #171717; background: #ffd400; font-size: 28rpx; font-weight: 900; }
.checkout-bar { position: fixed; left: 24rpx; right: 24rpx; bottom: calc(24rpx + env(safe-area-inset-bottom)); z-index: 8; display: flex; align-items: center; justify-content: space-between; gap: 24rpx; padding: 20rpx 22rpx; border-radius: 28rpx; background: #171717; box-shadow: 0 18rpx 40rpx rgba(0, 0, 0, .14); }
