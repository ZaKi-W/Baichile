...
<template>
  <view class="share-gacha persona-gacha">
    ...
    <template v-else-if="data && data.kind === 'persona' && data.persona">
      ...
      <view class="persona-stats"><view><text>订单</text><strong>{{ data.completedOrderCount }} 顿</strong></view><view><text>订单金额</text><strong>¥{{ (data.savedMoneyCents / 100).toFixed(2) }}</strong></view><view><text>热量</text><strong>{{ data.savedCaloriesKcal }} kcal</strong></view></view>
