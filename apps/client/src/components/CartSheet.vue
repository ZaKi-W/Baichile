...
.sheet { width: 100%; box-sizing: border-box; background: #fff; border-radius: 32rpx 32rpx 0 0; padding: 32rpx 28rpx; padding-bottom: calc(150rpx + env(safe-area-inset-bottom)); }
.sheet-head { display: flex; align-items: flex-start; justify-content: space-between; gap: 20rpx; margin-bottom: 20rpx; }
.title { display: block; font-size: 36rpx; font-weight: 900; }
.store-name { display: block; margin-top: 6rpx; color: #777; font-size: 23rpx; }
.clear-button { margin: 0; padding: 0 18rpx; border-radius: 18rpx; color: #666; background: #f6f6f6; font-size: 23rpx; line-height: 52rpx; }
...
.price { color: #f04426; font-weight: 900; }
...
.qty-button { width: 44rpx; height: 44rpx; margin: 0; padding: 0; border-radius: 50%; color: #171717; background: #ffd400; font-size: 26rpx; line-height: 44rpx; }
...
.footer-price { display: block; color: #171717; font-size: 34rpx; font-weight: 900; }
.checkout-button { min-width: 240rpx; height: 76rpx; margin: 0; padding: 0 28rpx; border-radius: 38rpx; color: #171717; background: #ffd400; font-size: 28rpx; font-weight: 900; line-height: 76rpx; }
.checkout-button[disabled] { color: #777; background: #dedede; }
