...
const PERSONAS: SharePersona[] = [
  ...
  persona('caln', 'CALN', '热量忍者', '热量刚到门口，你已经完成了整桌推演。', '对热量极其敏锐，最享受在虚拟点单里研究一整桌。', '看看你的热量人格'),
  ...
  persona('budg', 'BUDG', '订单金额审计官', '每一笔订单金额，都要算得有凭有据。', '你对价格有天然雷达，享受看着累计订单金额稳定上涨。', '测测你的订单金额人格'),
